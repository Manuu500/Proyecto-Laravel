            ...
            <div class="col d-flex justify-content-center align-items-center vh-100">
                <div class="row">
                    ...
                    <div class="mt-5" id="sobreNosotrosText">
                        <p>¡Bienvenidos a nuestra página de acogida de mascotas! Somos un equipo apasionado y comprometido con la misión de brindar amor y cuidado a los animales necesitados.</p>
                        <p>Tenemos sedes en todas las ciudades de España, desde Málaga hasta Barcelona.</p>
                        <div>
                            <button type="button"  onclick="window.location='{{ route('dashboard') }}'" class="btn btn-primary">Ver animales disponibles</button>
